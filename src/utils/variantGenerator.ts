...
// Cryptographically secure random number generator between 0 (inclusive) and 1 (exclusive)
...
// Helper to pick randomly from an array based on seed or secure random
